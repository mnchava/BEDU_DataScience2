...
setwd("~/Downloads/BEDU/postwork4")
dir()
library(dplyr)
...
lista <- lapply(c("Spain1-1718.csv", "Spain1-1819.csv", "Spain1-1920.csv"), read.csv)
...
colnames(SmallData)[1] <- "date"
colnames(SmallData)[2] <- "home.team"
colnames(SmallData)[3] <- "home.score"
colnames(SmallData)[4] <- "away.team"
colnames(SmallData)[5] <- "away.score"
